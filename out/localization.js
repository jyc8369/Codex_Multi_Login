...
const messages = {
    en: {
        ...
        editModeHint: "Open the edit view to reorder accounts in a compact list.",
        editModePanelTitle: "Edit accounts",
        editModePanelSubtitle: "Drag the compact rows to reorder accounts.",
    ...
    ko: {
        ...
        editModeHint: "편집 화면에서 간단한 목록으로 계정 순서를 바꿀 수 있습니다.",
        editModePanelTitle: "계정 편집",
        editModePanelSubtitle: "짧은 행을 드래그해서 계정 순서를 바꿉니다.",
