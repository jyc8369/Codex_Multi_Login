...
import { Locale, ThemeMode, t } from "./localization";
...
function renderAccountCard(account: CodexAccountRecord, locale: Locale): string {
    ...
    <div class="${cardClass}">
      <div class="card-head">
        ...
        <span class="card-actions">
          <button class="card-action secondary" onclick="send('switchAccount', '${escapeJs(account.id)}')">${t(locale, "switchAccount")}</button>
          <button class="card-action secondary" onclick="send('refreshAccount', '${escapeJs(account.id)}')">${t(locale, "refresh")}</button>
          <button class="card-action secondary" onclick="send('deleteAccount', '${escapeJs(account.id)}')">${t(locale, "delete")}</button>
        </span>
      </div>
